            ...
            <div className={clsx(styles.header, 'card__body')}>
                <DefinitionList className={clsx(styles.dl)}>
                    <dt className={clsx(styles.highlighted)}>
                        <Translate id="joi.event.start" description="Start of event">
                            Start
                        </Translate>
                    </dt>
                    <dd className={clsx(styles.highlighted)}>
                        {event.fStartDate} {event.fStartTime}
                    </dd>
                    <dt className={clsx(styles.highlighted)}>
                        <Translate id="joi.event.end" description="End of event">
                            Ende
                        </Translate>
                    </dt>
                    <dd className={clsx(styles.highlighted)}>
                        {event.fEndDate} {event.fEndTime}
                    </dd>
                    <dt className={clsx(styles.highlighted)}>
                    ...
                    <dd className={clsx(styles.highlighted)}>
                        {event.dayFullStart}
                        {event.fStartDate !== event.fEndDate ? ` - ${event.dayFullEnd}` : ''}
                    </dd>
                    <dt>
