        ...
        <div className={clsx(props.className)}>
            <BigCalendar
                ...
                messages={{
                    ...
                    previous: translate({
                        message: 'Vorherige',
                        id: 'calendar.button.previousWeek',
