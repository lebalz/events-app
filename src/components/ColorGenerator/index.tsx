...
import { getAdjustedColors } from './colorUtils';
...
const ColorGenerator = observer(() => {
    ...
    return (
            ...
            <div className={styles.actions}>
                ...
                <label htmlFor="primary_color">
                    <strong className="margin-right--sm">
                        <Translate id="colorGenerator.inputs.primary.label">Hauptfarbe</Translate>
                    </strong>
                </label>{' '}
                <input
                    type="color"
                    ...
                    text={translate(
                        ...
                        },
                        {
                            colorMode:
                                colorMode === 'dark'
                                    ? translate({
                                          id: 'colorGenerator.inputs.modeToggle.label.colorMode.light',
                                          message: 'heller'
                                      })
                                    : translate({
                                          id: 'colorGenerator.inputs.modeToggle.label.colorMode.dark',
                                          message: 'dunkler'
                                      })
                        }
                    )}
      ...
      */}
                ...
                <table className={styles.colorTable}>
                    ...
                    <tbody>
                        {getAdjustedColors(
                            ...
                            colors.data[colorMode].colors.primary
                        )
                                ...
                                return (
                                    <tr key={variableName}>
                                        <td>
                                            ...
                                            />
                                            <code className="margin-left--sm">{hex.toLowerCase()}</code>
                                        </td>
                                        <td>
                                        ...
                                        >
                                            <b>
                                                {wcagContrast(hex, colors.data[colorMode].colors.background)}
                                            </b>
                                        </td>
                                    </tr>
                                );
            ...
            <Details
                summary={translate({
                    id: 'colorGenerator.codeBlock.summary',
                    message: 'Farben-Code anzeigen'
                })}
                style={{ maxWidth: '100%' }}
            >
