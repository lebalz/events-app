...
const RegPeriodBadge = observer((props: Props) => {
    ...
    return (
        <div className={clsx(styles.badge)}>
            ...
            <Tooltip
                title={translate({
                    message: 'Eingabefenster: Einreichen von Terminen',
                    id: 'registrationPeriod.registrationWindow.tooltip'
                })}
            >
            ...
            <Tooltip
                title={translate({
                    message: 'Zeitraum, in dem die Termine stattfinden.',
                    id: 'registrationPeriod.eventWindow.tooltip'
                })}
            >
                <div className={clsx(styles.dateRange, 'badge')}>
            ...
            <Tooltip
                title={translate({
                    message: 'Termineingabe für diese Abteilungen (inkl. Bilingue)',
                    id: 'registrationPeriod.departments.tooltip'
                })}
            >
