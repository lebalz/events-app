                    ...
                    {i18n?.currentLocale === 'de' ? (
                        <div className="card" style={{ boxShadow: 'var(--ifm-global-shadow-md)' }}>
                            ...
                            <div className="card__body">
                                Der Terminkalender ist noch in der Beta-Phase, was folgende Einschränkungen
                                mit sich bringt:
                                <ul>
                                    <li>
                                        <b>
                                            Erfasste Termine werden aktuell noch nicht in den Terminplan
                                            aufgenommen!
                                        </b>
                                    </li>
                                    <li>
                                        Die Datenbank muss allenfalls während der Beta-Phase aktualisiert
                                        werden - sind selbst erfasste Termine betroffen, werden Sie
                                        informiert.
                                    </li>
                                    <li>
                                        Die URL der abonnierten Kalender könnte sich während der Beta-Phase
                                        ändern. Dann würden Sie informiert und müssten den Kalender erneut
                                        abonnieren.
                                    </li>
                                </ul>
                                Feedback kann über ein Bug-Tracking gemäss untenstehendem Video erfasst
                                werden.
