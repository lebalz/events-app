...
const EventTitleTranslation = {
    singular: translate({
        message: 'Termin',
        id: 'event.title',
        description: '[singular] Title of the event overview'
    }),
    plural: translate({
        message: 'Termine',
        id: 'event.title',
        description: '[plural] Title of the event overview'
    })
};
                    ...
                    {events.length === 1 ? (
                        <>
                            ...
                            <meta
                                ...
                                content={`${events[0].fStartDate} ${events[0].fStartTime} - ${events[0].fEndDate} ${events[0].fEndTime} @ ${events[0].location}`.slice(
                                    0,
                                    160
                                )}
                            />
                        ...
                        <>
                            ...
                            <meta
                                ...
                                content={events
                                    .map(
                                        (event) =>
                                            `${event.description}: ${event.fStartDate} ${event.fStartTime}`
                                    )
                                    .join(', ')
                                    .slice(0, 160)}
                            />
