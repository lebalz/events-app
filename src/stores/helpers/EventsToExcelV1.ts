...
export const toExcel = async (events: Event[], departments: Department[]) => {
    ...
    const depNames = [
        ...DEP_ORDER.filter((dep) => _depNames.includes(dep)),
        ..._depNames.filter((dep) => !_depNames.includes(dep)).sort()
    ];
    ...
    const columns = [
        ...
        {
            header: translate({ id: 'xlsx.weekday', message: 'Wochentag' }),
            key: 'weekday',
            width: 15,
            outlineLevel: 1
        },
        {
            header: translate({ id: 'xlsx.description', message: 'Titel' }),
            key: 'description',
            width: 42,
            outlineLevel: 1
        },
        {
            header: translate({ id: 'xlsx.dateStart', message: 'Datum Beginn' }),
            key: 'date_s',
            width: 15,
            outlineLevel: 1
        },
        {
            header: translate({ id: 'xlsx.timeStart', message: 'Zeit Beginn' }),
            key: 'time_s',
            width: 12,
            outlineLevel: 1
        },
        {
            header: translate({ id: 'xlsx.dateEnd', message: 'Datum Ende' }),
            key: 'date_e',
            width: 15,
            outlineLevel: 1
        },
        {
            header: translate({ id: 'xlsx.timeEnd', message: 'Zeit Ende' }),
            key: 'time_e',
            width: 12,
            outlineLevel: 1
        },
        {
            header: translate({ id: 'xlsx.location', message: 'Ort' }),
            key: 'location',
            width: 20,
            outlineLevel: 1
        },
        {
            header: translate({ id: 'xlsx.descriptionLong', message: 'Beschreibung' }),
            key: 'location',
            width: 20,
            outlineLevel: 1
        },
        ...
        {
            header: translate({ id: 'xlsx.classes', message: 'Klassen' }),
            key: 'classes',
            width: 10,
            outlineLevel: 1
        },
        {
            header: translate({ id: 'xlsx.affects', message: 'Betrifft' }),
            key: 'audience',
            width: 10,
            outlineLevel: 1
        },
        ...
        {
            header: translate({ id: 'xlsx.deletedAt', message: 'Gelöscht am' }),
            key: 'deletedAt',
            width: 15,
            outlineLevel: 1
        }
